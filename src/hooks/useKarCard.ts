...
const DEFAULT_POSTER_CONFIG: CanvasConfig = {
    ...
    zoom: 1.05,
    brand: { fontSize: 42, offsetX: 0, offsetY: -110 },
    model: { fontSize: 96, offsetX: 0, offsetY: -120 },
    details: { fontSize: 38, offsetX: 0, offsetY: -10 },
    year: { fontSize: 38, offsetX: 0, offsetY: -15 },
    price: { fontSize: 94, offsetX: 0, offsetY: -130 },
    fipe: { fontSize: 20, offsetX: 0, offsetY: -110, width: 280, height: 95, color: '#FFFFFF', gap: 28 },
    economy: { fontSize: 20, offsetX: 0, offsetY: -110, width: 280, height: 95, color: '#CCFF00', gap: 28 },
    karcashLogo: { fontSize: 26, offsetX: 0, offsetY: -127 },
